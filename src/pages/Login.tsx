...
export default function Login() {
  ...
  return (
    ...
    >
      <div>
        <h1 className="text-[30px] font-semibold tracking-[-0.035em] text-[#171d2b]">
          {content.title}
        </h1>
        ...
        <div className="my-7 flex items-center gap-3">
          ...
          <span className="whitespace-nowrap text-[12px] font-medium text-[#a0a3a8]">
            {content.divider}
          </span>
          <div className="h-px flex-1 bg-[#e1e3e7]" />
        </div>
        ...
        >
          ...
          <div>
            <div className="mb-2 flex items-center justify-between">
              <span className="text-[12px] font-semibold tracking-wide text-[#62666d]">
                {content.passwordLabel}
              </span>

              <button
                type="button"
                className="text-[13px] font-medium text-[#2864f0] hover:underline"
              >
        ...
        <p className="mt-7 text-center text-[14px] text-[#747c8d]">
          ...
          <Link
            to={content.footerHref}
            className="font-medium text-[#2864f0] hover:underline"
          >
