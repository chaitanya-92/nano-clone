                    ...
                    <div className="flex items-end justify-between gap-3">
                      <div>
                        ...
                        <p className="mt-1 text-xs text-[#8a92a0]">
                          Recommendations update from your professional
                          headline.
                        </p>
                      </div>
                    ...
                    <div className="mt-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {getIndustrySuggestions(formik.values.headline)
                          ...
                          .map((industry) => {
                            const selected =
                              formik.values.industries.includes(industry);
                        ...
                        <>
                          ...
                          <div className="mt-3 flex items-center gap-3">
                            ...
                            <input
                              ...
                              onBlur={() =>
                                formik.setFieldTouched("priceCents", true)
                              }
                              placeholder="0"
              ...
              {role === "brand" && step === 3 && (
                <div className="space-y-5">
                  ...
                  <p className="text-sm text-[#737c8d]">
                    Your profile will be saved to your workspace and can be
                    refined later.
                  </p>
                </div>
              )}
