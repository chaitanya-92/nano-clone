export const overviewStats = [
  ...
  export const creatorCard = {
    ...
    description: "This is how brands discover your positioning and collaboration offer.",
    actions: {
      open: "Open card",
      copy: "Copy card link",
      share: "Share my card",
  ...
  export const earningsData = {
    ...
    summary: [
      ...
      },
      {
        label: "In transit",
        value: "€0",
        description: "International transfers usually arrive within 1–7 days, depending on the destination and banking network.",
        icon: "transit",
        cloud: false,
      },
      {
    ...
    activity: {
      ...
      description: "Collaboration earnings, withdrawals and invoices in one place.",
      tabs: [
        {
          id: "earnings",
  ...
  export const communityData = {
    ...
    slack: {
      ...
      description: "Ask for feedback on a sponsored post, compare campaign lessons, meet creators in your language and help shape what Naano builds next.",
      benefits: [
    ...
    linkedin: {
      ...
      description: "Add your creator card to LinkedIn so brands can discover your work and join Naano through your attributed link.",
      commission: "25%",
    ...
    leaderboard: {
      ...
      description: "Estimated impressions generated by sponsored posts published for Naano brand collaborations.",
      metrics: {
        impressions: "Estimated impressions",
        posts: "Posts",
      },
      creators: [
        { rank: 1, name: "Eric David", type: "Public creator card", impressions: "267K", posts: 18 },
        { rank: 2, name: "Thomas Marcelle", type: "Public creator card", impressions: "170K", posts: 12 },
        { rank: 3, name: "Joseph Rudd", type: "Public creator card", impressions: "148K", posts: 11 },
        { rank: 4, name: "Emma Guetta", type: "Creator", impressions: "135K", posts: 10 },
        { rank: 5, name: "Kevin Meyer", type: "Public creator card", impressions: "65K", posts: 7 },
        { rank: 6, name: "Raj Vaibhav", type: "Public creator card", impressions: "45K", posts: 6 },
        { rank: 7, name: "TEODORA VUKASIN", type: "Creator", impressions: "45K", posts: 6 },
        { rank: 8, name: "Creator Eight", type: "Public creator card", impressions: "39K", posts: 5 },
        { rank: 9, name: "Creator Nine", type: "Creator", impressions: "35K", posts: 5 },
        { rank: 10, name: "Creator Ten", type: "Public creator card", impressions: "30K", posts: 4 },
        { rank: 11, name: "Mejda Dihi", type: "Public creator card", impressions: "26K", posts: 4 },
        { rank: 12, name: "Mehdi Tetopire", type: "Public creator card", impressions: "24K", posts: 4 },
        { rank: 13, name: "Sandhya Mishra", type: "Public creator card", impressions: "23K", posts: 3 },
        { rank: 14, name: "Tomas Loucky", type: "Public creator card", impressions: "23K", posts: 3 },
        { rank: 15, name: "malmoum chorouk", type: "Public creator card", impressions: "22K", posts: 3 },
        { rank: 16, name: "Divyanshi sharma", type: "Creator", impressions: "20K", posts: 3 },
        { rank: 17, name: "Robin Tempe", type: "Creator", impressions: "20K", posts: 3 },
        { rank: 18, name: "Nick Palasz", type: "Creator", impressions: "15K", posts: 2 },
        { rank: 19, name: "Thomas CLEMENT", type: "Public creator card", impressions: "14K", posts: 2 },
        { rank: 20, name: "Jorge Branger", type: "Public creator card", impressions: "14K", posts: 2 },
        { rank: 21, name: "Yonathan Cohen", type: "Creator", impressions: "13K", posts: 2 },
        { rank: 22, name: "Yonathan levy", type: "Public creator card", impressions: "13K", posts: 2 },
        { rank: 23, name: "Julius Nylund", type: "Creator", impressions: "11K", posts: 2 },
        { rank: 24, name: "Brianna Chapman", type: "Creator", impressions: "10K", posts: 2 },
        { rank: 25, name: "Lazarus Danjuma", type: "Public creator card", impressions: "9.9K", posts: 1 },
        { rank: 26, name: "Théophile Burnet", type: "Creator", impressions: "9.1K", posts: 1 },
        { rank: 27, name: "Kashmala Malik", type: "Creator", impressions: "8.6K", posts: 1 },
        { rank: 28, name: "Dilem Kaya", type: "Public creator card", impressions: "8.5K", posts: 1 },
        { rank: 29, name: "Can Timagur", type: "Creator", impressions: "7.9K", posts: 1 },
        { rank: 30, name: "Raouf Lemouchi", type: "Creator", impressions: "7.8K", posts: 1 },
      ],
    },
  } as const;
