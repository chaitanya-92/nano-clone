  ...
  return (
    <div className="dashboard-shell h-screen overflow-hidden bg-[#f6f8fb]">
      ...
      >
        ...
        <main className="dashboard-panel dashboard-scroll-area mx-3 mb-3 h-[calc(100vh-76px)] overflow-y-auto overscroll-contain rounded-[26px] border border-[#e3e5df] bg-white lg:mx-4">
