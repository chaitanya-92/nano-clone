    ...
    <header className="sticky top-0 z-30 h-[72px] border-b border-[#e8ebf0] bg-white">
      <div className="flex h-full items-center justify-between px-6">
        ...
        <div className="flex items-center gap-2">
          <Button
            variant="ghost"
            className="h-10 rounded-lg px-3 text-[13px] font-medium text-[#526078] hover:bg-[#f5f7fa] hover:text-[#202124]"
          >
          ...
          <div className="flex h-10 items-center gap-1 rounded-lg px-1">
            ...
            <Button
              variant="ghost"
              className="h-9 rounded-[9px] bg-white px-3 text-[12px] font-semibold text-[#202124] hover:bg-[#f5f7fa]"
            >
              EN
            </Button>
            ...
            <Button
              variant="ghost"
              className="h-9 rounded-[9px] px-3 text-[12px] font-semibold text-[#68748a] hover:bg-[#f5f7fa] hover:text-[#202124]"
            >
              FR
            </Button>
          </div>
          ...
          <Button
            variant="ghost"
            size="icon"
            className="h-10 w-10 rounded-full text-[#526078] hover:bg-[#f5f7fa] hover:text-[#202124]"
          >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger
              render={
                <Button
                  variant="ghost"
                  className="h-10 rounded-full p-0 hover:bg-transparent"
                />
              }
            >
            ...
            <DropdownMenuContent
              align="end"
              className="w-56 rounded-xl border-[#e8ebf0] bg-white p-2 shadow-lg"
            >
