            ...
            >
              ...
              <div className="mt-5 overflow-hidden rounded-xl border border-[#e7ebf0]">
                ...
                <div>
                  ...
                  <p className="mt-1 max-w-[190px] text-[13px] leading-5 text-[#8490a5]">
                    Hover the card for details and click to flip it.
                  </p>
                </div>
                ...
                <div className="flex w-[112px] flex-col gap-2">
                  <Link
                    to="/dashboard/my-card"
                    className="inline-flex h-9 w-full cursor-pointer items-center justify-center gap-2 rounded-lg border border-[#dce3ec] px-3 text-[12px] font-medium text-[#60708a] transition hover:bg-[#f8fafc]"
                  >
                    <ExternalLink className="h-3.5 w-3.5" />
                    Open card
                  </Link>
              ...
              <div
                className="mx-6 mb-6 cursor-pointer [perspective:1200px]"
                ...
                >
                  <div className="absolute inset-0 overflow-hidden rounded-[20px] border border-[#e0e4ec] bg-white shadow-[0_8px_30px_rgba(30,55,100,0.06)] [backface-visibility:hidden]">
                    <div className="relative h-[90px] bg-gradient-to-br from-[#2864f0] via-[#356cf3] to-[#6d8df4]">
                      ...
                      <Logo
                        compact={false}
                        href="/dashboard"
                        className="absolute left-1/2 top-4 -translate-x-1/2 text-white [filter:brightness(0)_invert(1)] [&>span:last-child]:text-[1.25rem]"
                      />
                      ...
                      <motion.div
                        ...
                        className="absolute -bottom-10 left-1/2 flex h-20 w-20 -translate-x-1/2 items-center justify-center overflow-hidden rounded-full border-4 border-[#2864f0] bg-white"
                      >
                        {profile?.profile_photo_url ? (
                          <img
                            src={profile.profile_photo_url}
                          ...
                          <Logo
                            compact
                            href="/dashboard"
                            className="[&>span:first-child]:scale-[0.9]"
                          />
                        )}
                      </motion.div>
                    </div>
                    ...
                    <div className="px-5 pb-5 pt-14 text-center">
                      ...
                      <div className="mt-5 flex justify-center">
                        <span className="inline-flex items-center gap-2 rounded-full border border-[#dce4ef] bg-white px-4 py-2 text-xs font-semibold text-[#52617b] shadow-[0_4px_12px_rgba(30,55,100,0.06)] transition-transform duration-200 group-hover:scale-[1.02]">
                          More details
                  ...
                  <div className="absolute inset-0 overflow-hidden rounded-[20px] border border-[#dce4ef] bg-white p-5 shadow-[0_12px_35px_rgba(30,55,100,0.08)] [backface-visibility:hidden] [transform:rotateY(180deg)]">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-[#8b9bb3]">
                          Performance & ICP
                        </p>
                      ...
                      <span className="flex h-9 w-9 items-center justify-center rounded-full bg-[#eef4ff] text-[#2864f0]">
                    ...
                    <div className="mt-4 rounded-xl border border-[#e2e8f0] bg-white p-4">
                      ...
                      <p className="mt-2 line-clamp-3 text-xs leading-5 text-[#7d899f]">
