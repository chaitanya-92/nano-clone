...
export function FinalCta() {
  ...
  return (
    <section
      id="final-cta"
      className="relative min-h-[1050px] overflow-hidden bg-[#eefaff] pt-[76px] sm:min-h-[1050px] lg:pt-[74px]"
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1000px] flex-col items-center px-6 text-center">
        ...
        >
          <p className="text-[13px] font-semibold tracking-[0.18em] text-[#376789]">
            {eyebrow}
          </p>
        ...
        <motion.div
          ...
          className="mt-[60px] w-full max-w-[570px] rounded-[30px] bg-white px-[51px] pb-[37px] pt-[38px] text-left shadow-[0_22px_65px_rgba(68,146,177,0.10)]"
        >
          <div className="flex items-center gap-4">
            ...
            />
            <p className="text-[13px] font-semibold tracking-[0.17em] text-[#376789]">
              {card.eyebrow}
            </p>
          </div>
          ...
          <div className="mt-[28px] border-t border-[#dceaf0]">
            {card.items.map((item) => (
              <div
                key={item}
                className="flex h-[52px] items-center gap-3 border-b border-[#dceaf0]"
              >
                <span className="h-[5px] w-[5px] shrink-0 rounded-full bg-[#376789]" />
                <span className="text-[16px] leading-none text-[#34383d]">
                  {item}
                </span>
              </div>
            ))}
          ...
          <motion.a
            ...
            whileHover={{ y: -1 }}
            whileTap={{ scale: 0.99 }}
            className="mt-[20px] flex h-[54px] w-full items-center justify-center gap-2 rounded-[13px] bg-[#191b1e] !text-white no-underline transition-shadow duration-300 hover:!text-white hover:shadow-[0_10px_24px_rgba(0,0,0,0.13)]"
          >
          ...
          <div className="mt-[19px] text-center text-[15px] text-[#747a81]">
            ...
            <a
              href="#"
              className="font-semibold text-[#202124] no-underline transition-opacity duration-200 hover:opacity-60"
            >
        ...
        <motion.p
          ...
          className="mt-[38px] text-[15px] tracking-[-0.01em] text-[#a5afb6]"
        >
          {trustText}
        </motion.p>
      </div>
