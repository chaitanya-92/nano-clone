...
import zmirovLogo from "@/assets/logos/zmirov-communication.png";
import davidZmirov from "@/assets/testimonials/david-zmirov.png";

const testimonialAssets = {
  companyLogo: zmirovLogo,
  personImage: davidZmirov,
};
...
export function FeaturedTestimonial() {
  ...
  return (
    <section
      id="testimonial"
      className="relative min-h-[720px] overflow-hidden bg-white py-20 sm:min-h-[735px] sm:py-24 lg:min-h-[750px] lg:py-24"
    >
      <div className="naano-shell flex w-full flex-col items-center text-center">
        <img
          src={testimonialAssets.companyLogo}
          alt={company.name}
          className="h-auto max-h-14 w-auto max-w-[180px] object-contain"
        />

        <div className="mt-4 h-[2px] w-[42px] bg-[#1769ff]" />

        <div
          ref={quoteRef}
          className="mx-auto mt-12 max-w-[950px] text-[clamp(2rem,3.4vw,3.5rem)] font-medium leading-[1.1] tracking-[-0.045em]"
        >
        ...
        <div className="mt-10 flex flex-col items-center">
          <img
            src={testimonialAssets.personImage}
            alt={person.name}
            className="h-24 w-24 rounded-full object-cover ring-1 ring-black/5"
          />

          <p className="mt-4 text-[18px] font-semibold tracking-[-0.02em] text-[#202124]">
            {person.name}
          </p>
