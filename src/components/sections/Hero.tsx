  ...
  return (
    <section className="relative overflow-hidden border-b border-border/35 bg-[#c9edff] py-20 sm:py-28 lg:py-32">
      <motion.img
        ...
        alt=""
        aria-hidden="true"
        className="pointer-events-none absolute -left-[5%] -top-[5%] z-0 h-[110%] w-[110%] max-w-none object-cover"
        animate={{ x: x * 32, y: y * 20 }}
        transition={{ type: "spring", stiffness: 65, damping: 20, mass: 0.6 }}
      />
      ...
      <div className="naano-shell relative z-10 text-center">
        ...
        <motion.div
          ...
          className="mt-9 inline-flex items-center gap-2 text-sm font-medium text-slate-600"
        >
