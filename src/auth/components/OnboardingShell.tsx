 ...
 return <div className={modal?"fixed inset-0 z-50 flex items-center justify-center bg-[#0b1020]/55 p-3 backdrop-blur-md md:p-6":"min-h-screen bg-[#f5f7fb] text-[#151923]"}>
  <div className={modal?"relative flex h-[calc(100vh-24px)] max-h-[920px] w-full max-w-[1180px] min-h-0 overflow-hidden rounded-[28px] bg-white shadow-[0_40px_120px_rgba(8,15,30,.28)]":"mx-auto flex min-h-screen max-w-[1540px]"}>
   ...
   <main className="flex min-h-0 min-w-0 flex-1 flex-col bg-white">
    <header className="relative z-10 flex shrink-0 items-center justify-between border-b border-[#edf0f4] bg-white px-6 py-5 md:px-10">{modal&&onClose&&<button type="button" onClick={onClose} className="order-2 rounded-full border border-[#e2e6ed] px-3 py-1.5 text-xs font-semibold text-[#6f7787] transition hover:bg-[#f6f8fb]">Esc · Close</button>}
    ...
    <div className="relative z-10 shrink-0 border-b border-[#edf0f4] bg-[#fbfcfe] px-6 py-5 md:px-10"><div className="mx-auto max-w-4xl"><Stepper steps={steps} current={current}/></div></div>
    <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain"><div className="mx-auto flex w-full max-w-4xl flex-col px-6 py-9 md:px-10 md:py-12">
